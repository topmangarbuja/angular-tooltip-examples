# Custom Tooltip using Angular CDK Overlay

This repository demonstrates a **simple Angular implementation of tooltips using the Angular CDK Overlay**.  
...
- Demonstrates attaching/detaching overlays on hover
